...
preprocessed_path = '/Data_HDD/fyp22_haochen_luo/strong/pytorch-vqa/resnet-14x14.h5/resnet152-95e0e999.pth'  # path where preprocessed features are saved to and loaded from
